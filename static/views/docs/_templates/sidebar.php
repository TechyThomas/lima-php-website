    ...
    <div class="docs-sidebar">
        ...
        <div class="docs-sidebar__content">
            <nav aria-label="Documentation pages">
                <a class="docs-nav-link <?php if (empty($data['current_doc']))
                    echo 'is-active'; ?>" href="/docs">
                    <span>Overview</span>
                    <?php echo lucide_icon('chevron-right'); ?>
                </a>
                <?php foreach ($data['docs'] as $docSlug => $doc): ?>
                    <a class="docs-nav-link <?php if (!empty($data['current_doc']) && $docSlug == $data['current_doc'])
                        echo 'is-active'; ?>" href="/docs/<?php echo $docSlug; ?>">
